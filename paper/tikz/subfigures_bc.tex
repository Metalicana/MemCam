...
\begin{subfigure}[t]{0.32\linewidth}
  ...
  \begin{minipage}[c][60mm][c]{\linewidth}
    \centering
    \input{tikz/retrieval_quality_comparison.tex}
  \end{minipage}
...
\begin{subfigure}[t]{0.32\linewidth}
  ...
  \begin{minipage}[c][60mm][c]{\linewidth}
    \centering
    \input{tikz/retention_selection_tradeoff.tex}
  \end{minipage}
...
% Whiskers are 95% trajectory-bootstrap intervals; KEEPSAKE uses B32.
