    ...
    for i in range(helper.num_scenes):
        ...
        for j in range(1):
            ...
            if config['skip_gen']:
                ...
                kf1_kf2_cameras = cameras[i*config['num_keyframes'] + j: i*config['num_keyframes'] + j + 2]
                ...
                for regen_id in range(config['regenerate_times'] + 1):
                    ...
                    kf_gen = KeyframeGen(config, inpainter_pipeline, mask_generator, depth_model, vae, rotation, 
                                        ...
                                        segment_model=segment_model, segment_processor=segment_processor, kf1_kf2_cameras=kf1_kf2_cameras).to(config["device"])
